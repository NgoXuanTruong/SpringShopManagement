...
public class UploadServiceImpl implements UploadService {
	...
	public File save(MultipartFile uploadFile, String storageFolder) {
		File dir = this.getDirectory(storageFolder);
		try {
			File savedFile = new File(dir, getUniqueName(uploadFile));
	...
	@Override
	public File getDirectory(String storageFolder) {
		File dir = new File(app.getRealPath(storageFolder));
		if(!dir.exists()) { // tạo mới nếu thư mục chưa tồn tại
			dir.mkdirs();
		}
		return dir;
	}
